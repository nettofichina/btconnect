...
function adicionarDupla() {
    ...
    if (jogador1 && jogador2) {
        const jogador1Normalizado = normalizarNome(jogador1);
        const jogador2Normalizado = normalizarNome(jogador2);
        const dupla = [jogador1Normalizado, jogador2Normalizado];
        
        if (!duplasManuais.some(d => d.includes(jogador1Normalizado) || d.includes(jogador2Normalizado))) {
            ...
            salvarEstado(); // Salva o estado após alteração
        } else {
